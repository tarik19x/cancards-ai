...
from app.rag.generate import build_user_prompt, parse_response

VALID_RESPONSE = json.dumps(
    {
        "answer_markdown": "The **Scotiabank Passport Visa Infinite** has no foreign transaction fee.",  # noqa: E501
        "recommended_cards": [
            {
